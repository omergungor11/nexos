...
const AGENTS = [
  {
    ...
    email: "ahmet@nexos.com.tr",
    bio: "15 yıllık emlak sektörü deneyimi ile İstanbul'un en prestijli projelerinde danışmanlık hizmeti sunmaktadır.",
  },
  {
    name: "Elif Kaya",
    slug: "elif-kaya",
    title: "Gayrimenkul Uzmanı",
    phone: "+90 555 200 30 40",
    email: "elif@nexos.com.tr",
    bio: "Konut ve ticari gayrimenkul alanında uzmanlaşmış, müşteri odaklı çalışma anlayışına sahip danışman.",
  },
  {
    name: "Mehmet Demir",
    slug: "mehmet-demir",
    title: "Yatırım Danışmanı",
    phone: "+90 555 300 40 50",
    email: "mehmet@nexos.com.tr",
    bio: "Gayrimenkul yatırım danışmanlığı ve portföy yönetimi konularında deneyimli profesyonel.",
  },
  {
    name: "Zeynep Arslan",
    slug: "zeynep-arslan",
    ...
    email: "zeynep@nexos.com.tr",
    bio: "Kurumsal ve bireysel kiralama süreçlerinde 10 yılı aşkın tecrübeye sahip danışman.",
  },
];
