  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8 max-w-2xl">
      ...
      <section className="space-y-4">
        <h2 className="text-base font-semibold border-b pb-2">Temel Bilgiler</h2>

        <Field label="Proje Adı" htmlFor="title" required>
          <Input
            id="title"
            name="title"
            value={form.title}
      ...
      {/* ---- Geliştirici ---- */}
      <section className="space-y-4">
        <h2 className="text-base font-semibold border-b pb-2">Geliştirici</h2>
        ...
        {/* Developer logo */}
        <div className="space-y-1.5">
          <label htmlFor="developer_logo" className="text-sm font-medium leading-none">Geliştirici Logosu</label>
          <div className="flex gap-2">
            <Input
              ...
              className="flex-1"
            />
            <Button type="button" variant="outline" onClick={() => openMediaPicker("logo")} className="gap-1.5 shrink-0">
          ...
          {form.developer_logo && /^https?:\/\/.+/.test(form.developer_logo) && (
            <div className="mt-2">
              <img src={form.developer_logo} alt="Logo önizleme" className="h-10 object-contain rounded border p-1" />
            </div>
          )}
        </div>
      </section>
      ...
      {/* ---- Konum ---- */}
      <section className="space-y-4">
        <h2 className="text-base font-semibold border-b pb-2">Konum</h2>
        ...
        <Field label="Adres / Konum" htmlFor="location" hint="Harita altında gösterilir.">
          <Input
            id="location"
            name="location"
            value={form.location}
        ...
        <div className="grid grid-cols-2 gap-4">
          <Field label="Enlem (Lat)" htmlFor="lat">
            <Input
              id="lat"
              name="lat"
              type="number"
      ...
      {/* ---- Fiyat & Birimler ---- */}
      <section className="space-y-4">
        <h2 className="text-base font-semibold border-b pb-2">Fiyat & Birimler</h2>
      ...
      {/* ---- Medya ---- */}
      <section className="space-y-4">
        <h2 className="text-base font-semibold border-b pb-2">Medya</h2>

        {/* Cover image */}
        <div className="space-y-1.5">
          <label htmlFor="cover_image" className="text-sm font-medium leading-none">Kapak Görseli</label>
          <div className="flex gap-2">
            <Input
              id="cover_image"
              name="cover_image"
              ...
              className="flex-1"
            />
            <Button type="button" variant="outline" onClick={() => openMediaPicker("cover")} className="gap-1.5 shrink-0">
              <ImageIcon className="size-4" />
              Galeri
            </Button>
          </div>
          {form.cover_image && /^https?:\/\/.+/.test(form.cover_image) && (
            <div className="mt-2">
              <img src={form.cover_image} alt="Kapak önizleme" className="h-32 w-auto rounded border object-cover" />
            </div>
          )}
        </div>
        ...
        <Field label="Galeri Görselleri" htmlFor="gallery_images" hint="URL'leri virgülle ayırarak girin.">
          <textarea
            id="gallery_images"
            name="gallery_images"
      ...
      {/* ---- Özellikler ---- */}
      <section className="space-y-4">
        <h2 className="text-base font-semibold border-b pb-2">Özellikler</h2>

        <Field label="Proje Özellikleri" htmlFor="features" hint="Virgülle ayırarak girin (ör: Yüzme Havuzu, Fitness, Güvenlik).">
          <textarea
            id="features"
            name="features"
            value={form.features}
            onChange={handleChange}
            rows={3}
            placeholder="Yüzme Havuzu, Fitness Salonu, 24 Saat Güvenlik, Çocuk Oyun Alanı"
            className={textareaClass}
          />
        </Field>
      </section>
      ...
      {/* ---- Durum ---- */}
      <section className="space-y-4">
        <h2 className="text-base font-semibold border-b pb-2">Durum</h2>
