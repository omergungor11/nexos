...
2. `nexos-docs/MEMORY.md` oku — kalici hafiza, teknik kararlar
3. `nexos-tasks/task-index.md` oku — dashboard + tum task durumlari
4. `nexos-tasks/active/session-notes.md` oku — onceki session notlari
